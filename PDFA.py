...
class PDFA:
    # @brief      A class representing a beta Accepting Probabilisitic
    ...
    def __init__(self, nodes, startNode, transFcn=None, accepts=None):
        ...
        # this is the final-state probability defining the beta-acceptance
        # condition. If a node has at least this probability of termination, it
        # is accepting
        self.beta = 0.9
